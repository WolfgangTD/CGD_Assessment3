...
public class UIManager3D : MonoBehaviour
{
    ...
    public TextMeshProUGUI PelletTrackerText;
    ...
    void Start()
    {
        ...
        scoreManager = GameController.GetComponent<GameStateController3D>();
    ...
    IEnumerator CountDown(GameObject screenCoverUI, TextMeshProUGUI startGameText)
    {
        ...
        countDownDone = true;
        StartCoroutine(cherryController.GetComponent<CherryController3D>().CherrySpawner());
    }
    ...
    IEnumerator GhostTimer()
    {
        ...
        GhostScareTimer.SetActive(false);
        player.GetComponent<PacStudentController3D>().isBuffed = false;
    }
}
